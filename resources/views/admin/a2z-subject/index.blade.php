...
@section('content')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                        <div class="card-body">
                        <a href="{{ url('/admin/a2z-subject/create') }}" class="btn btn-success btn-sm" title="Add New A2zSubject">
                                ...
                                @foreach($a2zsubject as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/a2z-subject/' . $item->id . '/edit') }}" title="Edit A2zSubject"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST"
                                                  action="{{ url('/admin/a2z-subject' . '/' . $item->id) }}"
                                                  accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger btn-sm"
                                                        title="Delete A2zSubject"
