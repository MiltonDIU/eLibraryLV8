                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif(!$item->coverImageFullUrl==null)
                                        <img width="150" src="{{ url($item->coverImageFullUrl)}}" alt="not found!">
                                    @else
                                        <img width="150"
                            ...
                            <tr>
                                <th>Item File</th>
                                <td> @if($item->pdfFullUrl) <a target="_blank" href="{{url($item->pdfFullUrl)}}"><img width="100" src="{{url('assets/image/download.png')}}" alt="not found!"></a>@endif </td>
