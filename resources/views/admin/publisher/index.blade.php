...
@section('content')
    ...
    <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ url('/admin/publisher/create') }}" class="btn btn-success btn-sm" title="Add New publisher">
                                ...
                                @foreach($publisher as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/publisher/' . $item->id . '/edit') }}" title="Edit publisher"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('/admin/publisher' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
