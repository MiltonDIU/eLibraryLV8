...
@section('content')
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ url('/admin/rating/create') }}" class="btn btn-success btn-sm" title="Add New Rating">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($rating as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('/admin/rating/' . $item->id . '/edit') }}" title="Edit Rating"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form method="POST" action="{{ url('/admin/rating' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $rating->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
