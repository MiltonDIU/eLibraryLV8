                    ...
                    <table id="dataTables" class="table table-borderless">
                        ...
                        @foreach($roles as $key=>$item)
                            <tr>
                                ...
                                <td>{{ $item->alias }}</td>
                                <td>
                                    <a href="{{ url('/admin/roles/' . $item->id) }}" title="View AclRole">
                                        <button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>
                                            View
                                        </button>
                                    </a>
                                    <a href="{{ url('/admin/roles/' . $item->id . '/edit') }}" title="Edit AclRole">
                                    ...
                                    <form method="POST" action="{{ url('/admin/roles' . '/' . $item->id) }}"
                                        ...
                                        {{ method_field('DELETE') }}
                                        {{ csrf_field() }}
                                        <button type="submit" class="btn btn-danger btn-sm" title="Delete AclRole"
