...
<div class="page-wrapper">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner ">
            <!-- BEGIN LOGO -->
            <div class="page-logo">
                <a href="{{url('/')}}"><img src="{{url('member/assets/image/logo.png')}}" width="170px"
                                            alt="eLibrary-DIU"></a>
    ...
    <div class="page-footer">
        <div class="page-footer-inner"> 2018 &copy; Library Theme By
            <a target="_blank" href="#">DIU</a> &nbsp;|&nbsp;
           </div>
